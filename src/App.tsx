        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/inventory/products/new" element={<ProtectedPage><RoleGuard allowedRoles={ROUTE_ROLES.inventory}><PermissionGuard anyOf={[...ROUTE_PERMISSIONS.inventory.anyOf]} shadowOnly={false} debugLabel="/inventory/products/new"><ProductCreatePage /></PermissionGuard></RoleGuard></ProtectedPage>} />
              <Route path="/inventory/products/:id" element={<ProtectedPage><RoleGuard allowedRoles={ROUTE_ROLES.inventory}><PermissionGuard anyOf={[...ROUTE_PERMISSIONS.inventory.anyOf]} shadowOnly={false} debugLabel="/inventory/products/:id"><ProductDetailPage /></PermissionGuard></RoleGuard></ProtectedPage>} />
              <Route path="/inventory/products/:id/edit" element={<ProtectedPage><RoleGuard allowedRoles={ROUTE_ROLES.inventory}><PermissionGuard anyOf={[...ROUTE_PERMISSIONS.inventory.anyOf]} shadowOnly={false} debugLabel="/inventory/products/:id/edit"><ProductEditPage /></PermissionGuard></RoleGuard></ProtectedPage>} />
              <Route path="/inventory/suppliers" element={<ProtectedPage><RoleGuard allowedRoles={ROUTE_ROLES.inventory}><PermissionGuard anyOf={[...ROUTE_PERMISSIONS.inventory.anyOf]} shadowOnly={false} debugLabel="/inventory/suppliers"><SuppliersPage /></PermissionGuard></RoleGuard></ProtectedPage>} />
              <Route path="/inventory/suppliers/:id" element={<ProtectedPage><RoleGuard allowedRoles={ROUTE_ROLES.inventory}><PermissionGuard anyOf={[...ROUTE_PERMISSIONS.inventory.anyOf]} shadowOnly={false} debugLabel="/inventory/suppliers/:id"><SupplierDetailPage /></PermissionGuard></RoleGuard></ProtectedPage>} />
              <Route path="/inventory/suppliers/:id/edit" element={<ProtectedPage><RoleGuard allowedRoles={ROUTE_ROLES.inventory}><PermissionGuard anyOf={[...ROUTE_PERMISSIONS.inventory.anyOf]} shadowOnly={false} debugLabel="/inventory/suppliers/:id/edit"><SupplierEditPage /></PermissionGuard></RoleGuard></ProtectedPage>} />
              <Route path="/inventory/movements" element={<ProtectedPage><RoleGuard allowedRoles={ROUTE_ROLES.inventory}><PermissionGuard anyOf={[...ROUTE_PERMISSIONS.inventory.anyOf]} shadowOnly={false} debugLabel="/inventory/movements"><StockMovementsPage /></PermissionGuard></RoleGuard></ProtectedPage>} />
              <Route path="/inventory/scrap/new" element={<ProtectedPage><RoleGuard allowedRoles={ROUTE_ROLES.inventory}><PermissionGuard anyOf={[...ROUTE_PERMISSIONS.inventory.anyOf]} shadowOnly={false} debugLabel="/inventory/scrap/new"><ScrapCreatePage /></PermissionGuard></RoleGuard></ProtectedPage>} />
              <Route path="/inventory/scrap/dashboard" element={<ProtectedPage><RoleGuard allowedRoles={ROUTE_ROLES.inventory}><PermissionGuard anyOf={[...ROUTE_PERMISSIONS.inventory.anyOf]} shadowOnly={false} debugLabel="/inventory/scrap/dashboard"><ScrapDashboardPage /></PermissionGuard></RoleGuard></ProtectedPage>} />
              <Route path="/inventory/scrap/disassembly" element={<ProtectedPage><RoleGuard allowedRoles={ROUTE_ROLES.inventory}><PermissionGuard anyOf={[...ROUTE_PERMISSIONS.inventory.anyOf]} shadowOnly={false} debugLabel="/inventory/scrap/disassembly"><ScrapDisassemblyPage /></PermissionGuard></RoleGuard></ProtectedPage>} />
              <Route path="/inventory/scrap/:id" element={<ProtectedPage><RoleGuard allowedRoles={ROUTE_ROLES.inventory}><PermissionGuard anyOf={[...ROUTE_PERMISSIONS.inventory.anyOf]} shadowOnly={false} debugLabel="/inventory/scrap/:id"><ScrapDetailPage /></PermissionGuard></RoleGuard></ProtectedPage>} />
