...
VALUES ('quotes.update', 'quotes', 'update', 'Editar orçamentos', false, true)
ON CONFLICT (key) DO NOTHING;

-- 2) Conceder aos roles atuais de ROUTE_ROLES.quotes em todos tenants
INSERT INTO public.role_permissions (tenant_id, role, permission_key, allowed)
SELECT t.id, r.role::app_role, 'quotes.update', true
FROM public.tenants t
CROSS JOIN (VALUES ('admin'),('manager'),('front_desk'),('bench_technician')) AS r(role)
